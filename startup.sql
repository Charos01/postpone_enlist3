...
CREATE TABLE IF NOT EXISTS aksiomatikos ( ADT varchar(50) NOT NULL , UNIQUE KEY ix_aks_adt (ADT), CONSTRAINT fk_aksiomatikos_user FOREIGN KEY (ADT) REFEREN>
CREATE TABLE IF NOT EXISTS aplication ( aplicationid int(11) NOT NULL , date_created date NOT NULL , date_modified date , status int NOT NULL , paper varch>
